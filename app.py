...
def user_in_the_space (room_id, user_email):
    """Check if user is alresdy a member of the Webex Space"""
...
def send_message_to_person(person_email, markdown_text, attachments = '[]'):
    """Send a 1:1 Webex message to a user"""
    messages_api_url = webex_api_url + "/" + "messages"
    payload = json.dumps ({
...
def refresh_tokens():
    """Function to refresh Service App Refresh Token"""
...
def run_for_ever():
    """Run the script forever, and pause the execution 1 day"""
    while True:
        main_function()
        time.sleep(86400)
    ...
    if new_users:
        for user in new_users:
            ...
            if user_added:
                ...
                card_body = [
                    {
                        ...
                        "content": {
                            ...
                            "body": [
                                {
                                    "type": "Image",
                                    "url": "https://www.webex.com/content/dam/www/us/en/logos/CiscoWebex-Logo_white.png"
                                },
                                {
                                    "type": "TextBlock",
                ...
                # welcome_message = "Hi <@personEmail:" + user_email  +  ">" + ", welcome to ACME company"
                # one example I found: welcome_message = "Hi <@personEmail:" + user_email + "|" + user_name + ">" + ", welcome to ACME company"
